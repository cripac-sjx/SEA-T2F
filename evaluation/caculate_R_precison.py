...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        ...
                        default='cfg/face.yml', type=str)
    parser.add_argument('--gpu', dest='gpu_id', type=int, default=0)
    parser.add_argument('--valid_dir', dest='Vdir', type=str, default='/home/jianxin.sun/CelebAMask-HQ/training_data/test/')
    parser.add_argument('--data_dir', dest='data_dir', type=str, default='')
    parser.add_argument('--manualSeed', type=int, help='manual seed')
    parser.add_argument('--attr_path', dest='attr_path', type=str, default='/home/jianxin.sun/CelebAMask-HQ/CelebAMask-HQ-attribute-anno.txt')
    parser.add_argument('--selected_attrs', dest='selected_attrs', nargs='+', help='selected attributes for the CelebA dataset',
...
if __name__ == "__main__":
    ...
    dataset_val = TextDataset(cfg.DATA_DIR, 'test', args.attr_path, args.selected_attrs,
                          base_size=cfg.TREE.BASE_SIZE,
                          transform=image_transform)
